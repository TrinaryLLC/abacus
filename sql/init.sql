...
CREATE TABLE methodologies (
    ...
    FOREIGN KEY (TYPE_ID) REFERENCES methodology_types(ID) ON DELETE CASCADE,
...
CREATE TABLE strategy_identifier (
    ID INTEGER PRIMARY KEY DEFAULT nextval('seq_strategy'),
    TYPE_ID INTEGER NOT NULL,
    FOREIGN KEY (TYPE_ID) REFERENCES strategy_identifier_types(ID) ON DELETE CASCADE,
...
CREATE TABLE strategy_identifier_relationship (
    ...
    FOREIGN KEY (STRATEGY_IDENTIFIER_ID) REFERENCES strategy_identifier(ID) ON DELETE CASCADE,
...
CREATE TABLE instruments (
    ...
    TYPE_ID INTEGER NOT NULL,
    FOREIGN KEY (TYPE_ID) REFERENCES instrument_types(ID) ON DELETE CASCADE,
...
CREATE TABLE instrument_identifier_relationship (
    ...
    FOREIGN KEY (INSTRUMENT_IDENTIFIER_ID) REFERENCES instrument_identifier(ID) ON DELETE CASCADE,
    TYPE VARCHAR(255) DEFAULT 'REFERENCES',    
...
CREATE TABLE instrument_identifier (
    ...
    TYPE_ID INTEGER NOT NULL,
    FOREIGN KEY (TYPE_ID) REFERENCES instrument_identifier_types(NAME) ON DELETE CASCADE,
    VALUE VARCHAR(255) NOT NULL,
    UNIQUE (TYPE, VALUE)
...
CREATE TABLE instrument_classifications(
    ...
    FOREIGN KEY (INSTRUMENT_CLASSIFICATION_TYPE_ID) REFERENCES instrument_classification_types(ID) ON DELETE CASCADE,
    VALUE = VARCHAR(255) NOT NULL,
...
CREATE TABLE instrument_classification_relationship (
    ...
    FOREIGN KEY (CLASSIFICATION_ID) REFERENCES instrument_classifications(ID) ON DELETE CASCADE,
...
JOIN methodologies m ON smr.METHODOLOGY_ID=m.ID
...
INSERT INTO strategies (VALID_FROM) VALUES (CURRENT_DATE);